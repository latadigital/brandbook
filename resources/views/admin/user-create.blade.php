                            ...
                            {{ Form::open(array('route' => 'admin_user_create_post', 'class'=>'row g-3', 'method' => 'post')) }}
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                        <input type="text" class="form-control border-start-0" id="firstname" name="firstname" placeholder="Juan" value="{{ old('firstname') }}" />
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group"> <span class="input-group-text"><i class='bx bxs-user'></i></span>
                                        <input type="text" class="form-control border-start-0" id="lastname" name="lastname" placeholder="Perez" value="{{ old('lastname') }}" />
                                    </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group"> <span class="input-group-text"><i class='bx bxs-message'></i></span>
                                        <input type="text" class="form-control border-start-0" id="inputEmailAddress" name="email" placeholder="Email" value="{{ old('email') }}" />
                                    </div>
                                ...
                                <div class="col-12 mt-5">
                                    <button type="submit" class="btn btn-light px-5">Agregar</button>
                                </div>
                            {{ Form::close() }}
                        </div>
                    </div>
